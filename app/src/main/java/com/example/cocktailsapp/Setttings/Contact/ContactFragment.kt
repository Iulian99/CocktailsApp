package com.example.cocktailsapp.Setttings.Contact
...
class ContactFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        // Set phone brand, model, and system version
    ...
    private fun sendFeedback() {
        ...
        val intent = Intent(Intent.ACTION_SENDTO).apply {
            ...
            putExtra(Intent.EXTRA_EMAIL, arrayOf("your_email@example.com")) // destinatarul email-ului
